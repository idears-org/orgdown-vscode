...
#+END_FIXTURE
#+EXPECTED: :type scope
'#+BEGIN_SRC python -n :results output' => {{scopes.BLOCK_SRC_META}}, {{scopes.BLOCK_KEYWORD}}
...
"#+END_SRC" => {{scopes.BLOCK_KEYWORD}}

'#+BEGIN_SRC shell :tangle "my file.py"' => {{scopes.BLOCK_SRC_META}}, {{scopes.BLOCK_KEYWORD}}
  - "#+BEGIN_" => {{scopes.BLOCK_KEYWORD}}
