...
#+EXPECTED: :type scope
'#+INCLUDE: "headline.org"' => {{scopes.META_DIRECTIVE}}
  - '#+INCLUDE:' => {{scopes.INCLUDE_KEYWORD}}
  - '"headline.org"' => {{scopes.INCLUDE_PATH}}
...
#+EXPECTED: :type scope
'#+INCLUDE: "list.org"' => {{scopes.META_DIRECTIVE}}
  - '#+INCLUDE:' => {{scopes.INCLUDE_KEYWORD}}
  - '"list.org"' => {{scopes.INCLUDE_PATH}}
...
#+EXPECTED: :type scope
'#+INCLUDE: "table.org"' => !{{scopes.META_DIRECTIVE}}
  - '#+INCLUDE:' => !{{scopes.INCLUDE_KEYWORD}}
  - '"table.org"' => !{{scopes.INCLUDE_PATH}}
...
#+END_FIXTURE
#+EXPECTED: :type scope
'#+INCLUDE: "file.org"' => {{scopes.META_DIRECTIVE}}
  - '#+INCLUDE:' => {{scopes.INCLUDE_KEYWORD}}
  - '"file.org"' => {{scopes.INCLUDE_PATH}}
":lines" => {{scopes.BLOCK_PARAMETER_KEY}}
